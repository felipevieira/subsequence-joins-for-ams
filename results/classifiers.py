...
# features= features.drop('(simple_mfcc(A,B) - simple_mfcc(A,C)) / simple_mfcc(B,C)', axis = 1)
	...
	if mode == "tune":
		...
		#CONF Random Forest60	auto	None	4	4
...
# print('Testing Labels Shape:', test_labels.shape)
	...
	et = ExtraTreesClassifier(n_estimators=1000, criterion="gini", max_features="auto", max_depth=None, min_samples_split=4, min_samples_leaf=2, n_jobs=-1)
	rf = RandomForestClassifier(n_estimators=60, criterion="gini", max_features="auto", max_depth=None, min_samples_split=4, min_samples_leaf=4, n_jobs=-1)#RandomForestClassifier(n_estimators=1000, criterion="entropy")
